...
CREATE TABLE IF NOT EXISTS fund_signal_snapshot (
  ...
  position_percentile_0_100 DOUBLE PRECISION NULL,
  position_bucket TEXT NULL,

  dip_buy_proba_5t DOUBLE PRECISION NULL,
  dip_buy_proba_20t DOUBLE PRECISION NULL,
  magic_rebound_proba_5t DOUBLE PRECISION NULL,
  magic_rebound_proba_20t DOUBLE PRECISION NULL,
